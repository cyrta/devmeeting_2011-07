...
var aspect={
	add: function(obj, fn, aspectFn, when, once){
		(obj==null || obj=='undefonded')?obj=window:obj=this;
		if(when==null || when=='undefonded')when='before';
		if(once=='undefinded') once=false;
		if(once){
		if( typeof(fn)=='string'|| typeof(fn)=='array' || typeof(fn)=='regexp'){
