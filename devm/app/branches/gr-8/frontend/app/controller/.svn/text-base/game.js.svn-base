...
//            this.__createBullets(1000);
        ...
        __onCollision: function (data) {
            ...
            (objectA.type != 2 && objectB.type != 2)) {
               ...
               var pos1 = objectA.__position;
               var pos2 = objectB.__position;
               var vel1 = objectA.__velocity;
               var vel2 = objectB.__velocity;
               var r1 = objectA.__boundingBox.r;
               var r2 = objectB.__boundingBox.r;
               var posDiff = vec3.create();
               vec3.subtract(pos2, pos1, posDiff);
               var diffDir = vec3.create();
               vec3.normalize(posDiff, diffDir);
